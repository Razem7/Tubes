...
<div class="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-10 bg-gray-50">
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-2">Buat akun dan mulai berjualan 🚀</p>
        </div>

        {{-- Card --}}
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            <h1 class="text-xl font-bold text-gray-900 mb-6">Buat akun baru</h1>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}"
                           ...
                           class="w-full px-4 py-2.5 border rounded-xl text-sm transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent {{ $errors->has('name') ? 'border-red-400 bg-red-50' : 'border-gray-300' }}"
                ...
                <div>
                    ...
                    <input type="text" id="phone_number" name="phone_number" value="{{ old('phone_number') }}"
                           ...
                           class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" id="password_confirmation" name="password_confirmation"
                               ...
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-10"
                               required>
                ...
                {{-- Submit --}}
                <button type="submit"
                        class="w-full py-3 rounded-xl text-sm font-semibold text-white transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 mt-2"
        ...
        <p class="text-center text-xs text-gray-400 mt-6">
            Dengan mendaftar, kamu menyetujui syarat & ketentuan GadgetHub.
        </p>
    </div>
</div>
