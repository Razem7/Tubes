...
@section('title', 'Detail Transaksi - GadgetHub')
    ...
    <div class="bg-white rounded-lg shadow-md p-8 mb-6">
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <img src="{{ $transaction->product->photos->first() ? asset('storage/' . $transaction->product->photos->first()->photo_url) : 'https://via.placeholder.com/400x300?text=No+Image' }}" alt="{{ $transaction->product->title }}" class="w-full h-64 object-cover rounded-lg mb-4">
